...
var app = (function () {
    ...
    /* src\count.svelte generated by Svelte v3.49.0 */
    ...
    class Count extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*name*/ ctx[0] === undefined && !('name' in props)) {
    			console.warn("<Count> was created without expected prop 'name'");
    		}
    	}
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "href", "#/");
    			add_location(a0, file, 13, 2, 220);
    			attr_dev(a1, "href", "#/count");
    			add_location(a1, file, 14, 2, 244);
    			add_location(div, file, 12, 1, 212);
    			attr_dev(main, "class", "svelte-1h6otfa");
    			add_location(main, file, 11, 0, 204);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ name, Home, Count, Router, routes });
